...
<div class="app-main__outer">
    ...
    <div class="row">
        <div class="main-card mb-3 card col-12">
            <div class="card-body">
                <form class="formLPD" method="post" action="{{ route('bunga.update', $bungas->id) }}" enctype="multipart/form-data" novalidate>
                {{csrf_field() }}
                    {{method_field('put')}}
                    <div class="position-relative row form-group">
                        <label for="exampleEmail" class="col-sm-2 col-form-label">Bunga</label>
                        <div class="col-sm-10">
                            <input name="bunga" id="bunga" placeholder="Masukkan Jumlah Bunga" type="text" class="form-control" value="{{$bungas->bunga}}" required>
