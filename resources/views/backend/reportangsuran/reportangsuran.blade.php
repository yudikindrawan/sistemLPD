...
<table class="table table-bordered" style="border:none;">
    <tr>
        <td style="border: none;">
        <center>
            <b style="font-size:16px;">LAPORAN ANGSURAN KESELURUHAN</b>
...
<div class="box-body table-responsive">
    <table id="example" class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $angs->transaksi_id }}</td>
                <td>{{ $angs->tanggal_pembayaran }}</td>
                <td>Rp. {{ number_format($angs->jumlah_pembayaran ,2)}}</td>
                <td>Rp. {{ number_format($angs->sisa_pembayaran ,2)}}</td>
                <td>Rp. {{ number_format($angs->sisa_kredit ,2)}}</td>
                <td>Rp. {{ number_format($angs->pembayaran_bunga ,2)}}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
